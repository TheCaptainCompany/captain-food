...
| app | boundary | hosts | declared | resolved | honest | via | secrets | missing |
|---|---|---|---|---|---|---|---:|---|
| `gateway-admin` | platform | `/admin/graphql`: routes 136 field(s) to 8 subgraph(s); 74 authorized for ADMIN | -- | -- | yes | -- | 10 | -- |
| `gateway-customer` | customer | `/customer/graphql`: routes 136 field(s) to 8 subgraph(s); 46 authorized for CUSTOMER | -- | -- | yes | -- | 10 | -- |
| `gateway-external` | platform | `/external/graphql`: routes 136 field(s) to 8 subgraph(s); 10 authorized for EXTERNAL | -- | -- | yes | -- | 10 | -- |
| `gateway-public` | customer | `/public/graphql`: routes 136 field(s) to 8 subgraph(s); 9 authorized for PUBLIC | -- | -- | yes | -- | 10 | -- |
| `gateway-restaurant` | restaurant | `/restaurant/graphql`: routes 136 field(s) to 8 subgraph(s); 34 authorized for RESTAURANT | -- | -- | yes | -- | 10 | -- |
| `gateway-restaurant-account` | restaurant | `/restaurant-account/graphql`: routes 136 field(s) to 8 subgraph(s); 55 authorized for RESTAURANT_ACCOUNT | -- | -- | yes | -- | 10 | -- |
| `gateway-rider` | delivery | `/rider/graphql`: routes 136 field(s) to 8 subgraph(s); 17 authorized for RIDER | -- | -- | yes | -- | 10 | -- |
