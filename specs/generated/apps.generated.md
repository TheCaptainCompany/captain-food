...
| `graphql-delivery` | delivery | scope `delivery`: 4 quer(ies), 15 mutation(s), 0 subscription(s) | delivery | **all 8** | **fat +7** | `bin_runtime`, `server` | 15 | -- |
...
| app | boundary | hosts | declared | resolved | honest | via | secrets | missing |
|---|---|---|---|---|---|---|---:|---|
| `gateway-admin` | platform | `/admin/graphql`: routes 131 field(s) to 8 subgraph(s); 70 authorized for ADMIN | -- | -- | yes | -- | 10 | -- |
| `gateway-customer` | customer | `/customer/graphql`: routes 131 field(s) to 8 subgraph(s); 46 authorized for CUSTOMER | -- | -- | yes | -- | 10 | -- |
| `gateway-external` | platform | `/external/graphql`: routes 131 field(s) to 8 subgraph(s); 10 authorized for EXTERNAL | -- | -- | yes | -- | 10 | -- |
| `gateway-public` | customer | `/public/graphql`: routes 131 field(s) to 8 subgraph(s); 9 authorized for PUBLIC | -- | -- | yes | -- | 10 | -- |
| `gateway-restaurant` | restaurant | `/restaurant/graphql`: routes 131 field(s) to 8 subgraph(s); 34 authorized for RESTAURANT | -- | -- | yes | -- | 10 | -- |
| `gateway-restaurant-account` | restaurant | `/restaurant-account/graphql`: routes 131 field(s) to 8 subgraph(s); 55 authorized for RESTAURANT_ACCOUNT | -- | -- | yes | -- | 10 | -- |
| `gateway-rider` | delivery | `/rider/graphql`: routes 131 field(s) to 8 subgraph(s); 16 authorized for RIDER | -- | -- | yes | -- | 10 | -- |
