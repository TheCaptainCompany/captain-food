...
pub const REMINDER_SCHEDULES: &[ReminderSchedule] = &[
    ...
    ReminderSchedule { actor_type: "RestaurantInvitation", on_message: "InviteRestaurantMember", reminder: "RestaurantInvitationExpired", payload_event: "RestaurantInvitationExpired", identity_prop: "invitationId", after_key: "RESTAURANT_INVITATION_TTL_SECONDS", after_default: std::time::Duration::from_secs(604800), reschedule: ReschedulePolicy::Keep },
