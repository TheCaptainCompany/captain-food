...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    ("20260903060000_auth_subject_reservations.sql", include_str!("../../../../migrations/20260903060000_auth_subject_reservations.sql")),
    ("20260904021500_delivery_job_open_issue.sql", include_str!("../../../../migrations/20260904021500_delivery_job_open_issue.sql")),
    ("20260904060000_delivery_job_handback.sql", include_str!("../../../../migrations/20260904060000_delivery_job_handback.sql")),
    ("20260904090000_ordertracking_delivery_handed_back.sql", include_str!("../../../../migrations/20260904090000_ordertracking_delivery_handed_back.sql")),
    ("20260904110000_rider_standing.sql", include_str!("../../../../migrations/20260904110000_rider_standing.sql")),
    ("20260904160000_rider_roster.sql", include_str!("../../../../migrations/20260904160000_rider_roster.sql")),
    ("20260905110000_member_bridge_and_scope_membership_grant.sql", include_str!("../../../../migrations/20260905110000_member_bridge_and_scope_membership_grant.sql")),
    ("20260905130000_restaurant_roster_and_invitation_list.sql", include_str!("../../../../migrations/20260905130000_restaurant_roster_and_invitation_list.sql")),
    ("20260905150000_platform_member_bridge.sql", include_str!("../../../../migrations/20260905150000_platform_member_bridge.sql")),
];
