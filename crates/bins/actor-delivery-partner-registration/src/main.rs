...
//! `actor-delivery-partner-registration` — mailbox worker realizing the `DeliveryPartnerRegistration` aggregate -- drains ONLY its own lanes (the scoping is the linker).
//!
