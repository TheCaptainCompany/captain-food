...
pub const ERRORS: &[ErrorDef] = &[
    ...
    PLATFORM_ACCESS_GRANT_DOOR_CLOSED,
    PLATFORM_ACCESS_ALREADY_GRANTED,
    PLATFORM_MEMBERSHIP_ID_MISMATCH,
    ADMIN_SIGN_IN_DOOR_CLOSED,
    ADMIN_SIGN_IN_REQUIRES_SESSION,
    ...
    RESTAURANT_INVITATION_DOOR_CLOSED,
    RESTAURANT_INVITATION_NOT_FOUND,
    RESTAURANT_INVITATION_ALREADY_REVOKED,
    RESTAURANT_INVITATION_NOT_ACCEPTABLE,
    MEMBER_NOT_LINKED,
    MEMBER_SIGN_IN_REQUIRES_SESSION,
    MEMBER_SIGN_IN_DOOR_CLOSED,
    RESTAURANT_PAUSED,
    OFFER_UNAVAILABLE,
    INSUFFICIENT_STOCK,
