...
pub enum DomainEvent {
    ...
    CustomerErasureRequested(CustomerErasureRequested),
    CustomerErasureConfirmed(CustomerErasureConfirmed),
    CustomerErasureCancelled(CustomerErasureCancelled),
    CustomerErasureDue(CustomerErasureDue),
    CustomerIdentityUnlinked(CustomerIdentityUnlinked),
    CustomerErased(CustomerErased),
    ...
    RestaurantInvitationSent(RestaurantInvitationSent),
