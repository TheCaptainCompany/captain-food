# Claude rules — Evidence — what counts as proof, and what only looks like it

Green is not proof, prose is not verification, and a claim a reader cannot re-run is not evidence.
The most expensive mistakes in this repo live here.
