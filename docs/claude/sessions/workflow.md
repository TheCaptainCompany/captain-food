# Claude rules — Workflow — git, GitHub, claims, commits and the mob

Claim/PR/commit mechanics, the traps in each, and how work survives a session that ends mid-flight.
