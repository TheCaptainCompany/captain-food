# Claude rules — Gates, builds and what each one actually proves

Which gate to run, what it compiles, and what it silently leaves out. Cost of getting this wrong is
measured in whole gate rounds.
...
### libtest captures a passing test's stderr
