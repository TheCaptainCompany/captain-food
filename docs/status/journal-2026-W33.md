...
Journal entries for ISO week 2026-W33, newest first, in the order they were written.
...
> [docs/claude/sessions/gates.md §18](../claude/sessions/gates.md#18-a-ci-workflow-change-does-it-fit-the-jobs-timeout-and-does-it-regress-the-rollback-path):
> a mob briefing for a CI-workflow change must ask
