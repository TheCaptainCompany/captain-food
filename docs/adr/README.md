...
| [20260804-171030](20260804-171030-single-box-hosting-self-managed-postgres.md) | **One VPS runs app + PostgreSQL + Redis** (amends ADR-20260731-061609, revises PROP-20260731-061609 D1/D2) — the ~€160/month managed-HA shape is deferred on budget grounds for a €10.40 OVH VPS-3 in France. Postgres on the HOST, app and Redis in containers (*system of record on the host, rebuildable in a container*), backups offsite to a DIFFERENT provider with a restore rehearsal gating the DNS cut. French hosting preserved, so ADR-0042 needs no amendment |
