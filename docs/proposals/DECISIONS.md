...
| D4 | The read door — **shape decided 2026-08-02**: `get_operation_status(message_id)` on each actor client, no separate client type | In the client crate, phase 1 (absorbs the #284 tail once, not twice) |
