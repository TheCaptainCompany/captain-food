...
**2026-08-10**: row **G** added — the one open item in this section — the #429 keystone cart-pricing
decision (LIVE re-price on read vs LOCKED at add-to-cart).
