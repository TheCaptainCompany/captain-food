...
- **Realized by**: [ADR-20260810-112836 "Cart priced LIVE on read"](../adr/ADR-20260810-112836-cart-priced-live-on-read.md) + the #451 PR on `claude/epic-429-production-test-order-9atwb8` (Phase 1 / AMBER spec slice landed 2026-08-10; Phase 2 / GREEN code in the same PR — link filled at merge)
