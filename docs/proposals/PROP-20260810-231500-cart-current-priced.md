...
- **Status**: Proposed
- **Date**: 2026-08-10
- **Tracking issue**: _(REQUIRED — to be created by the coordinator; wire the full clickable link here on filing, e.g. `[#NNN "cart.current returns the authenticated customer's priced cart"](https://github.com/TheCaptainCompany/captain-food/issues/NNN)`)_
